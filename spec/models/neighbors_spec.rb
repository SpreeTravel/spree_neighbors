...
describe Spree::Neighbors do
  it 'creates its associations correctly' do
    ...
    l.neighbors_settings = neighb_set
    l.location = loc2
    l.neighbors_settings.location.latitude.should be_equal(23.129)
    l.neighbors_settings.location.longitude.should be_equal(-82.38)
  end
end